...
var AnchorifyText = (function (_React$Component) {
  ...
  function AnchorifyText(props) {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(AnchorifyText).call(this, props));
  }
    ...
    value: function anchorify(text) {
      ...
      matches.forEach(function (match, i) {
        ...
        if (_react2.default.Children.count(_this2.props.children) === 1) {
          result.push(_react2.default.cloneElement(_this2.props.children, { url: match.url, key: keyMatch }));
        } else {
          result.push(_react2.default.createElement(
            'a',
...
AnchorifyText.propTypes = {
  ...
  linkify: _react2.default.PropTypes.object,
